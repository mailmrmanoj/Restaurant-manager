...
def system():
    ...
    def DisplayData():
        ...
        mycursor.execute("SELECT * FROM Restaurantrecords")
    ...
    my_tree['columns'] = ("ordno", "piz", "bur", "ice",
                          "dr", "ct", "sb", "tax", "sr", "tot")
    ...
    def add():
        ...
        if orders == "" or pizzas == "" or burgers == "" or ices == "" or drinkss == "" or costs == "" or subtotals == "" or taxs == "" or services == "" or totals == "":
            ...
            mycursor.execute(
                'INSERT INTO Restaurantrecords (ordno, piz, bur , ice ,dr ,ct ,sb ,tax, sr, tot) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',
    ...
    def DisplayData():
        ...
        my_tree.delete(*my_tree.get_children())
        cursor = mycursor.execute("SELECT * FROM Restaurantrecords")
        fetch = mycursor.fetchall()
        for data in fetch:
            my_tree.insert('', 'end', values=(data))
        cursor.close()
    ...
    main_lbl = Label(topframe, font=('Calibri', 15,),
                     text=localtime, fg="lightgreen", anchor=W)
    ...
    # cost
    costlbl = Label(leftframe, font=('Calibri', 16, 'bold'),
